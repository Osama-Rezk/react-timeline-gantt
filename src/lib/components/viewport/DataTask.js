...
export default class DataTask extends Component {
  ...
  render() {
    ...
    const name = Config.values.dataViewPort.task.showLabel ? this.props.item.name : '';
    ...
    return (
      ...
      >
        <div
          ...
          style={{ top: 0, left: -4, height: style.height, border: '1px solid blue' }}
        ...
        {console.log(MOVE_RESIZE_LEFT, MOVE_RESIZE_RIGHT, LINK_POS_RIGHT, LINK_POS_LEFT)}

        <div style={{ overflow: 'hidden' }}>{this.props.renderCard ? this.props.renderCard(this.props.item) : name}</div>

        <div
          className="timeLine-main-data-task-side"
          style={{ top: 0, left: style.width - 3, height: style.height, border: '1px solid blue' }}
